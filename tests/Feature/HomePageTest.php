...
test('home page renders the public landing page', function () {
    ...
    $this->get('/')
        ...
        ->assertSeeText('To nie jest zwykły test.')
        ->assertSee('learning/classic-mode', false)
        ->assertSee('learning/focus-mode', false)
        ...
        ->assertSeeText('Pobierz aplikację mobilną i ucz się')
        ->assertSeeText('Setki pytań, realne testy i pełna wygoda.')
        ->assertSeeText('Błąd zostaje tam, gdzie możesz do niego wrócić.')
        ->assertSeeText('Na końcu próbny egzamin.')
        ->assertSeeText('Opinie użytkowników PrawkoNaRaz')
        ->assertSeeText('Sprawdzone przed publikacją')
        ...
        ->assertSee('"@type":"WebSite","name":"PrawkoNaRaz"', false)
        ->assertSee('"@type":"Organization","name":"PrawkoNaRaz"', false)
