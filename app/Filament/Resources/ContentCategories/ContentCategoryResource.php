...
class ContentCategoryResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'kategoria aktualności';

    protected static ?string $pluralModelLabel = 'kategorie aktualności';

    protected static ?string $navigationLabel = 'Kategorie aktualności';
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->withCount([
                'articles',
                'articles as publicly_visible_articles_count' => fn (Builder $query): Builder => $query->publiclyVisible(),
                'articles as actively_distributed_articles_count' => fn (Builder $query): Builder => $query->activelyDistributed(),
            ]);
    }
