...
- `GET /logout` nie istnieje jako fallback i nie wylogowuje uzytkownika.
...
| P2 | `GET /logout` | Zamkniete | Mozliwe logout CSRF / przypadkowe wylogowanie | Usunieto fallback GET; wylogowanie zostaje tylko przez POST z CSRF |
...
5. Done: usunac `GET /logout`; wylogowanie zostaje tylko przez `POST`.
...
- punkt 9 jest wykonany: logout zostaje tylko przez `POST`.
