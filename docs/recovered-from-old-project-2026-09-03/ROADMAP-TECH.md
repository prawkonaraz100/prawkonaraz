...
> **Uwaga OSK V2.12 (2026-08-24):** poniższy zakres jest ogólną roadmapą B2B.
> Jeśli praca dotyczy OSK, rozpocznij od [docs/osk/README.md](./osk/README.md).
> Dla OSK canonical membership to `OrganizationUser` / `organization_users`,
> a nie starsze `organization_members` wymienione w tej ogólnej roadmapie.
