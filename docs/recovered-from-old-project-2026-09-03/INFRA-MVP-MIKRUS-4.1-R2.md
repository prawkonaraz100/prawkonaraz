...
- aktualny publiczny base URL mediow: `https://prawkonaraz.pl/storage-bulk`,
...
Codzienny/manualny deploy zmian po pierwszym uruchomieniu serwera opisuje
kanoniczny runbook:
...
- `MEDIA_PUBLIC_BASE_URL=https://prawkonaraz.pl/storage-bulk`, zeby sitemapy i JSON-LD nie wskazywaly juz tymczasowej domeny `wild-bison5536.byst.re`,
