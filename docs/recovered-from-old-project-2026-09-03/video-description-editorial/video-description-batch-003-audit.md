# Audyt opisów video sitemap — batch 003

Data audytu: 2026-05-29 16:57 Europe/Warsaw
Zakres: 50 rekordów z `video-description-batch-003.csv`
...
| Minimalna długość | 179 znaków |
| Maksymalna długość | 209 znaków |
| Średnia długość | 191,0 znaków |
...
- Batch 003 zawiera wiele podobnych kadrów autostradowych, dlatego opisy różnią się konkretnym punktem obserwacji: pas wyłączenia, koniec pasa, wybór pasa, sygnalizowanie, wjazd na autostradę.
- W części dotyczącej korytarza życia opisy skupiają się na układzie pojazdów i wolnej przestrzeni dla służb, bez rozstrzygania odpowiedzi egzaminacyjnej.
- W opisach dla kategorii AM zachowano krótszy, konkretny opis sceny i uniknięto powtarzania pełnej treści pytania.
