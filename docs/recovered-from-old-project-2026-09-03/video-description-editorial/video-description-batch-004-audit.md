# Audyt opisów video sitemap — batch 004

Data audytu: 2026-05-29 17:04 Europe/Warsaw
Zakres: 50 rekordów z `video-description-batch-004.csv`
...
| Minimalna długość | 176 znaków |
| Maksymalna długość | 207 znaków |
| Średnia długość | 192,7 znaków |
...
- Batch 004 zawiera wiele powtarzalnych kadrów kategorii AM, dlatego opisy różnią się punktem obserwacji: włączanie do ruchu, boczny wlot, linia zatrzymania, sygnalizator albo ruch poprzeczny.
- Opisy celowo unikają rozstrzygnięć typu `masz obowiązek`, `wolno Ci`, `musisz`, nawet jeśli występują one w promptach pytań.
- Przy podobnych sygnalizatorach i skrzyżowaniach opis dotyczy widocznych elementów sceny, a nie odpowiedzi testowej.
