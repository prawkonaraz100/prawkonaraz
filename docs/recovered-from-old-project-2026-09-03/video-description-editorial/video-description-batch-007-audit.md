# Audyt opisów video sitemap — batch 007

Data audytu: 2026-06-01 14:53 Europe/Warsaw
Zakres: 50 rekordów z `video-description-batch-007.csv`
...
| Minimalna długość | 169 znaków |
| Maksymalna długość | 202 znaki |
| Średnia długość | 187,2 znaków |
...
- Batch 007 obejmuje zróżnicowane kategorie AM, A, B i D: autobusy, tramwaje, przejazdy kolejowe, zimowe drogi, rowerzystów i skrzyżowania.
- Przy podobnych kadrach tramwajowych i nocnych opisy różnią punkt obserwacji: torowisko, pojazd szynowy, kierunek jazdy, światła albo relację z pieszymi.
- Opisy nie przenoszą rozstrzygnięć z promptów i unikają fraz typu `masz obowiązek`, `musisz`, `należy`, `wolno Ci`.
