...
Branch roboczy: `codex/legal-articles-alcohol-green-arrow`
...
- dodano idempotentny seeder `LegalTrustLayerMvpSeeder` z 33 tematami i powiązaniami pytań,
...
- opublikowano artykuł `sygnal-dzwiekowy`, oparty o art. 29 ust. 1-2, art. 30 ust. 1 pkt 1 lit. b oraz § 11 ust. 1 pkt 6 rozporządzenia technicznego; z 32 pytań kanonicznych 20 otrzymało zweryfikowane relacje, a 12 pozostawiono bez publikacji z powodu zależności od mediów albo innej głównej podstawy prawnej,
- opublikowano artykuł `zabezpieczenie-ladunku-i-wymiary`, oparty o art. 61; utworzono 24 precyzyjne relacje pytań dotyczących masy, stateczności, mocowania, wymiarów i oznakowania ładunku,
- opublikowano artykuł `przyczepa-masa-wymiary-i-oswietlenie`, oparty o art. 62 i § 12 ust. 1 pkt 11 rozporządzenia technicznego; utworzono 8 relacji pytań dotyczących masy, długości zespołu i bocznych odblasków,
- opublikowano artykuł `wjazd-na-przejazd-kolejowy`, oparty o art. 28 oraz przepisy dotyczące znaku STOP i czerwonego sygnału; utworzono 23 zweryfikowane relacje,
- opublikowano artykuł `holowanie-pojazdu`, oparty o art. 31 i art. 45 ust. 1 pkt 2; utworzono 14 zweryfikowanych relacji dotyczących parametrów i zakazów holowania,
- opublikowano artykuł `pasy-bezpieczenstwa`, oparty o art. 39 ust. 1 i dwa precyzyjne wyjątki; utworzono 8 zweryfikowanych relacji,
- opublikowano artykuł `swiatla-do-jazdy-dziennej-i-mijania`, oparty o art. 51 ust. 1-2 oraz art. 30 ust. 1 pkt 1 lit. a; utworzono 11 zweryfikowanych relacji,
- opublikowano artykuł `rogatki-i-sygnaly-na-przejezdzie-kolejowym`, oparty o art. 28 ust. 1-3 oraz § 98 ust. 5; utworzono 13 zweryfikowanych relacji dotyczących obserwacji torów, ruchu zapór i czerwonego sygnału,
- opublikowano artykuł `swiatla-przeciwmglowe`, oparty o art. 30 ust. 1 pkt 1 lit. a, art. 30 ust. 3 i art. 51 ust. 5; utworzono 10 zweryfikowanych relacji dotyczących świateł przednich, tylnych i progu widoczności 50 m,
- opublikowano artykuł `foteliki-i-przewoz-dzieci`, oparty o art. 39 ust. 3-4 oraz art. 45 ust. 2 pkt 4-6; utworzono 14 zweryfikowanych relacji dotyczących urządzeń przytrzymujących, wyjątków i zakazów,
- opublikowano artykuł `obowiazki-uczestnika-wypadku`, oparty o art. 44 ust. 1-3; utworzono 11 zweryfikowanych relacji dotyczących zabezpieczenia miejsca, pomocy, służb, pojazdów i danych,
- opublikowano artykuł `telefon-podczas-kierowania`, oparty o art. 45 ust. 2 pkt 1; utworzono 6 zweryfikowanych relacji rozróżniających trzymanie telefonu od zestawu niewymagającego trzymania,
- opublikowano artykuł `swiatla-drogowe-i-oslepianie`, oparty o art. 51 ust. 3 i ust. 4 pkt 1-2; utworzono 11 zweryfikowanych relacji dotyczących warunków użycia, pojazdu z przeciwka i pojazdu poprzedzającego,
- opublikowano artykuł `gasnica-trojkat-i-obowiazkowe-wyposazenie`, oparty o wymagania techniczne samochodu, motocykla, ciągnika i pojazdu przewożącego osoby; utworzono 6 zweryfikowanych relacji,
- opublikowano artykuł `opony-bieznik-i-cisnienie`, oparty o § 11 ust. 5 i 7 rozporządzenia technicznego; utworzono 7 zweryfikowanych relacji, a pytania o ciśnienie oleju odrzucono jako fałszywe dopasowania,
- opublikowano artykuł `dokumenty-podczas-kontroli-drogowej`, oparty o art. 38 Prawa o ruchu drogowym; utworzono 22 zweryfikowane relacje dotyczące dokumentów uprawnienia, pokwitowań, blokady alkoholowej, pojazdów zagranicznych i jazd testowych,
- opublikowano artykuł `kategorie-prawa-jazdy-i-uprawnienia`, oparty o ustawę o kierujących pojazdami; utworzono 23 zweryfikowane relacje dotyczące kategorii AM, A1, A2, A, B1, B i T, krajowych rozszerzeń oraz ważności i wymiany dokumentu,
- opublikowano artykuł `alkohol-i-srodki-dzialajace-podobnie`, oparty o art. 45 Prawa o ruchu drogowym, art. 46 ustawy o wychowaniu w trzeźwości, art. 87 Kodeksu wykroczeń i art. 178a Kodeksu karnego; utworzono 8 zweryfikowanych relacji, a pytania o ogólne skutki psychofizyczne pozostawiono poza warstwą prawną,
- opublikowano artykuł `zielona-strzalka-warunkowa`, oparty o § 96 ust. 1-3 rozporządzenia w sprawie znaków i sygnałów drogowych; utworzono 4 zweryfikowane relacje dotyczące obowiązku pełnego zatrzymania,
- opublikowano artykuł `pojazd-uprzywilejowany`, oparty o art. 2 pkt 38, art. 9, art. 24 ust. 11 oraz § 58 ust. 3; wszystkie 6 pytań klastra otrzymało zweryfikowane relacje dotyczące korytarza życia albo granicy zakazu wyprzedzania,
- opublikowano artykuł `sygnal-zolty-i-zolty-migajacy`, oparty o § 95 ust. 1 pkt 2 i 4 oraz § 98 ust. 6; wszystkie 4 pytania klastra przypisano do funkcji ostrzegawczej żółtego sygnału migającego,
...
- `php artisan test tests/Feature/Public/LegalTrustLayerMvpTest.php` - OK, 33 testy / 901 asercji,
- `php artisan test tests/Feature/PublicQuestionDatabasePageTest.php` - OK, 15 testów / 382 asercji,
- `php artisan test tests/Feature/Public/SeoSitemapGenerationTest.php` - OK, 9 testów / 93 asercje,
