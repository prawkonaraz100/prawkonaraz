...
Status: Etap 1 aktywny na produkcji; Etap 2 kompletny lokalnie, objety testami i recznie zweryfikowany; oczekuje na osobny commit oraz deploy
Branch: `codex/learning-inline-sign-thumbnails`
...
- Funkcja jest aktywna na produkcji:
  `STUDY_EXPLANATION_SIGN_REFERENCES_ENABLED=true`.
...
- [x] Funkcja zostala wlaczona dla calej nauki po akceptacji Etapu 1.
...
## Kolejny krok: wydanie Etapu 2

Etap 2 nie jest jeszcze na produkcji. Przed wydaniem nalezy:

1. Wyodrebnic i sprawdzic diff dotyczacy tylko miniaturek i korekt znakow,
   bez przypadkowego dolaczenia innych zmian z roboczego katalogu.
2. Utworzyc osobny commit z migracja, modelami, panelem, runtime i testami.
3. W trakcie deployu uruchomic migracje, odswiezyc cache aplikacji i wykonac
   szybka kontrole w produkcyjnym panelu na jednym pytaniu.
4. Dopiero po pozytywnym wyniku redakcja moze zaczac dodawac rzeczywiste
   korekty. Kazda korekta jest odwracalna przez usuniecie jej w formularzu.
