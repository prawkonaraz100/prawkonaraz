...
Status: `HISTORICAL SHADOW IMPORT / PRODUCTION FULL-TOPIC ROLLOUT ACTIVE`

Ostatnia aktualizacja: 2026-07-28
Zakres: historyczny import pilota `secondary:zawracanie`; aktywny canary V2
obejmuje wszystkie 29 źródeł topicu, a pozostałe topici nadal używają V1
...
1. Po pomyślnym shadow i P0 uruchomiono ten sam run w rolloutcie nr 1 jako
`mode=canary`, a po osobnym preview, backupach i zgodzie promowano ekspozycję
z `5%` do `100%` dla wszystkich 29 źródeł topicu. Pozostałe topici nadal
używają V1. Szczegóły: `docs/SEO-RELATION-V2-CANARY-RUNBOOK.md`.
...
„Zawracanie”. Publiczny canary V2 jest aktywny dla całego topicu (29/29); każdy
kolejny topic wymaga osobnej decyzji. Szczegóły operacyjne, backupy i warunek
