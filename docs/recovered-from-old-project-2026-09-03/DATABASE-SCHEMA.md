...
> **Uwaga dla OSK V2.12 (2026-08-24):** poniższy fragment jest starszym,
> ogólnym szkicem B2B. Dla nowego modułu OSK canonical nazewnictwo i kolejność
> wdrożenia są opisane w [docs/osk/README.md](./osk/README.md) oraz
> [planie OSK V2.12](./osk/OSK_V2_12_IMPLEMENTATION_PLAN.md). W szczególności
> nie implementuj tabeli `organization_members` jako membershipu OSK;
> obowiązuje `OrganizationUser` / `organization_users`. Aktualne repozytorium
> nie ma jeszcze żadnej z tych tabel.
