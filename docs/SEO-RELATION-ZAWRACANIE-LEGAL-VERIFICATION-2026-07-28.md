...
Status: `COMPLETE FOR DEFINED SCOPE / SHADOW ONLY / PUBLIC CANARY OFF`
...
Nie jest to porada prawna ani samodzielna zgoda na publiczny canary. Nie
zmienia odpowiedzi pytań, relacji V1/V2, indeksacji ani widoku publicznego.
Run nr 2 pozostaje aktywny wyłącznie w `mode=shadow`, przy ekspozycji `0%`.
...
| Publiczny HTML / indeksacja | `bez zmian` |
| Publiczny canary V2 | `NIE WŁĄCZONO` |

Kolejny krok może być wyłącznie osobną, świadomą decyzją o canary wraz z
zabezpieczeniem backupu, krótkim oknem ekspozycji i automatycznym pomiarem
bramek. Shadow oraz podpisany preview nadal są wystarczające do bezpiecznego
oglądania V2 bez wpływu na użytkowników i SEO.
