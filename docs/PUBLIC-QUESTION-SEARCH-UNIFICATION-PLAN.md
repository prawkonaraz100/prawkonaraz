...
Data: 2026-07-02  
Branch bazowy planu: `codex/public-question-search-plan`
Branch aktualnej iteracji UX: `codex/public-question-search-results-page`
...
Aktualizacja UX z 2026-07-02 wykonana na branchu `codex/public-question-search-results-page`:

- dodano dedykowana strone wynikow:
  - `/oficjalna-baza-pytan-na-prawo-jazdy/szukaj`,
  - route name: `public.questions.search`,
- formularze w headerze oraz na stronie kategorii wysylaja teraz zapytania do tej strony wynikow,
- hub z parametrem `q` albo legacy `question` przekierowuje do `/szukaj`,
- kategoria z parametrem `q` albo `gov_id` przekierowuje do `/szukaj?category=...`,
- strona kategorii pozostaje spokojna lista kategorii i pytan, a nie ekranem wynikow,
- wyniki wyszukiwania z filtrem kategorii nadal sa filtrowane po kategorii, ale linkuja do czystych globalnych URL-i pytan `/pytanie/...`,
- strona wynikow ma `noindex,follow`, zeby nie indeksowac dowolnych fraz uzytkownikow, ale przekazywac sygnal do stron pytan,
- schema.org `SearchAction` wskazuje teraz `/oficjalna-baza-pytan-na-prawo-jazdy/szukaj?q={search_term_string}`.
- ikona lupy w headerze, na stronie wynikow i na stronie kategorii jest prawdziwym przyciskiem submit, wiec uzytkownik moze kliknac w ikone zamiast wciskac Enter,
- inputy wyszukiwania maja neutralne tlo po wpisaniu tekstu/autofillu, bez niebieskiego podswietlenia przegladarki,
- kategorie w wynikach wyszukiwania sa kompaktowe:
  - widac liczbe kategorii,
  - widac tylko krotkie kody kategorii bez prefiksu `Kat.`,
  - przy dlugiej liscie pokazujemy pierwsze 5 kodow i licznik `+N`.
...
- 2026-07-02 po pierwszej implementacji: 28 testow, 601 asercji.
- 2026-07-02 po wydzieleniu czystej strony wynikow: 29 testow, 618 asercji.
...
Aktualne oczekiwane URL-e po wydzieleniu strony wynikow:

- `/oficjalna-baza-pytan-na-prawo-jazdy?q=3540`
  - przekierowuje do `/oficjalna-baza-pytan-na-prawo-jazdy/szukaj?q=3540`
- `/oficjalna-baza-pytan-na-prawo-jazdy?question=3540`
  - przekierowuje do `/oficjalna-baza-pytan-na-prawo-jazdy/szukaj?q=3540`
- `/oficjalna-baza-pytan-na-prawo-jazdy/szukaj?q=ostatnim%20wagonem`
  - renderuje czysta strone wynikow bez sekcji kategorii,
  - pokazuje pytanie `3540`,
  - link wyniku prowadzi do `/pytanie/3540/...`
- `/oficjalna-baza-pytan-na-prawo-jazdy/a?q=ostatnim%20wagonem`
  - przekierowuje do `/oficjalna-baza-pytan-na-prawo-jazdy/szukaj?q=ostatnim%20wagonem&category=a`
- `/oficjalna-baza-pytan-na-prawo-jazdy/szukaj?q=ostatnim%20wagonem&category=a`
  - pokazuje wyniki ograniczone do kat. A, ale linkuje do globalnego URL-a pytania.
...
- wydzielono czysta strone wynikow `/szukaj`, zeby uzytkownik nie ladowal na stronie kategorii podczas wyszukiwania.
- kategorie zachowuja kontekst wyszukiwania przez parametr `category`, ale wyniki linkuja do globalnych stron pytan.

Do zrobienia w tej iteracji:

- po akceptacji UX: commit, deploy i produkcyjny smoke `/szukaj`.

Weryfikacja dodatkowa dla aktualizacji UX:

- `npm run build` przeszedl po zmianie formularzy Vue.
- `docker exec serwistestyprawojazdy-app-1 php artisan test tests/Feature/PublicQuestionDatabasePageTest.php`
  - 29 testow, 621 asercji po dopracowaniu UX i kompaktowych oznaczeniach kategorii.
